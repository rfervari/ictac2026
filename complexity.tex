...
The key is a \emph{selection function} (see~\cite[Th.~6.37]{blackburn2001modal}), whose novelty here is the ability of handling data comparisons. In what follows, we will use~$*$ to refer indistinctly to $=$ or $\neq$ in data comparisons.
